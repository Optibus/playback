...
A Python decorator-based framework that lets you "record" service operations as they are executed and
intercepts all inputs and outputs, which can be used later to replay the exact operation in a controlled isolated
